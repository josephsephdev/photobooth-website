...
const plans = [
  ...
  },
  {
    ...
    priceNote: '/month',
    description:
      'Built for photographers, event planners, and businesses that run frequent events. Enjoy unlimited access to every feature with the flexibility to cancel anytime.',
    features: [
  ...
  },
  {
    ...
    priceNote: '/year',
    description:
      'The ultimate plan for studios, agencies, and power users. Lock in the lowest rate and get exclusive perks — save over ₱1,400 compared to monthly billing.',
    features: [
      'Everything in Pro Monthly',
      'Save ₱1,400+ vs monthly',
