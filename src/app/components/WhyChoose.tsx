  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-0 w-96 h-96 bg-[#00d4aa]/8 rounded-full blur-[80px]" />
        <div className="absolute bottom-1/3 right-0 w-96 h-96 bg-[#00bcd4]/8 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="relative bg-gradient-to-br from-ev-surface/90 to-ev-surface-elevated/90 rounded-2xl p-6 border border-ev-border group-hover:border-[rgba(0,212,170,0.3)] transition-colors duration-200">
        ...
        >
          {[
            ...
            >
              <div className="relative bg-gradient-to-br from-ev-surface/90 to-ev-surface-elevated/90 rounded-2xl p-8 border border-ev-border text-center">
